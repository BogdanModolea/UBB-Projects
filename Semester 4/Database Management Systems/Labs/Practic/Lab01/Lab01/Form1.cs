...
namespace Lab01
{
    ...
    {
        private readonly string TEAMS_TABLE = "StudentMember";
        private readonly string PLAYERS_TABLE = "Task";
        private readonly string FK_TEAMS_PLAYERS = "FK__Task__smid__412EB0B6";
        ...
        {
            dbConnection = new SqlConnection("Data Source=DESKTOP-TH52825;Initial Catalog=practic;Integrated Security=True");
            ...
            var dataRelation = new DataRelation(
                FK_TEAMS_PLAYERS,
                dataSet.Tables[TEAMS_TABLE].Columns["id"],
                dataSet.Tables[PLAYERS_TABLE].Columns["smid"]
            );
