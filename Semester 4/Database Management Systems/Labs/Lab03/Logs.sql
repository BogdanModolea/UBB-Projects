...
GO
CREATE OR ALTER PROCEDURE sp_log_changes @newData VARCHAR(100), @info VARCHAR(100), @error VARCHAR(100) AS
BEGIN
	INSERT INTO LogChanges (currentTime, info, new_data, error) VALUES
	(GETDATE(), @info, @newData, @error)
END