...
void Test::test_movie(){
    ...
    assert(mov.get_title() == "Before I met you");
    assert(mov.get_genre() == "Romance");
    assert(mov.get_year() == 2014);
    assert(mov.get_likes() == 50000);
    assert(mov.get_trailer() == "www.trailer.ro");

    Movie mov2{"Before I met you", "Romance", 2020, 100000, "www.trailer.ro"};
    assert(mov == mov2);
    Movie mov3 = mov;
    //mov3 = mov;
    assert(mov3 == mov);
