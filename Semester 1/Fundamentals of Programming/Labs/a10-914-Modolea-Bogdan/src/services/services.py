...
class Services:
    ...
    def update_person(self, person_id, name, phone):
        ...
        new_person = Person(person_id, name, phone)
        old_person = Person(person_id, now_person.name, now_person.phone)
...
7        :param new_time:
    ...
    def get_dates_to_print(self, date):
        ...
        return some_filter(my_activities, lambda x: date in x.date)
    ...
    def get_times_to_print(self, time):
        ...
        return some_filter(my_activities, lambda x: time in x.time)
    ...
    def get_descriptions_to_print(self, description):
        ...
        return some_filter(my_activities, lambda x: description.lower() in x.description.lower())
    ...
    def get_sorted_dates(self, date):
        ...
        my_activities_to_sort = sort(my_act, key=lambda x: x.time)
    ...
    def get_busiest_day(self):
        ...
        my_busiest_day = sort(my_busiest_day, key=lambda x: x[1], reverse=True)
